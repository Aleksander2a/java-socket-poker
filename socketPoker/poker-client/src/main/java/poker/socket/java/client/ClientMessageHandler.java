 ...
 * Provides methods to deal with messages from server, take according input from
 * user and send it back to the server.
 */
public class ClientMessageHandler {
    ...
    /**
     * Method to transform message form server into a LinkedHashMap, so the
     * keys and their values are easily accessible
     * @param input raw message from server
     * @return LinkedHashMap of key:value pairs containing specific info needed by client
     */
    ...
    /**
     * Specific method to encode the value of "GameInfo" key from server.
     * Prints out current information about the game.
     * @param gameInfo value of "GameInfo" key, accessed through a hash map
     *                 generated by encode() function
     */
    ...
    /**
     * Specific method to encode the value of a specific player's hand from server.
     * @param handRankInfo value of specific player's hand, accessed through a hash map
     *                 generated by encode() function
     * @return Info about player's hand that can be easily printed out
     */
    ...
    /**
     * Method that acts accordingly to game phase, taking the right input form
     * client and sending it back to server
     * @param msg LinkedHashMap containing key:value pairs with easily accessible
     *            info about the game and the player.
     * @return Player's input, coded in a way that can be sent and the server
